...
-device pcie-root-port,bus=pcie.0,addr=17.0,multifunction=on,port=0,chassis=8,id=root.1,pref64-reserve=32M \
...
-device xio3130-downstream,id=downstream_port1.6,bus=upstream_port1.1,chassis=5 \
-device xio3130-downstream,id=downstream_port1.7,bus=upstream_port1.1,chassis=6 \
-device xio3130-downstream,id=downstream_port1.8,bus=upstream_port1.1,chassis=7 \
...
-device vfio-pci,host=b1:00.0,bus=downstream_port1.6,addr=0x00,multifunction=on \
-device vfio-pci,host=b1:00.1,bus=downstream_port1.6,addr=0x00.1 \
-device vfio-pci,host=b1:00.2,bus=downstream_port1.6,addr=0x00.2 \
-device vfio-pci,host=b1:00.3,bus=downstream_port1.6,addr=0x00.3 \
-device vfio-pci,host=96:00.0,bus=downstream_port1.7,addr=0x00,multifunction=on \
-device vfio-pci,host=96:00.1,bus=downstream_port1.7,addr=0x00.1 \
-device vfio-pci,host=96:00.2,bus=downstream_port1.7,addr=0x00.2 \
-device vfio-pci,host=96:00.3,bus=downstream_port1.7,addr=0x00.3 \
